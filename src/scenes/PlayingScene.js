...
import { addMobEvent, removeOldestMobEvent, addMob} from "../utils/mobManager";
import Mob from "../characters/Mob";
import { addAttackEvent, setAttackScale, setAttackDamage, removeAttack} from "../utils/attackManager"
import TopBar from "../ui/TopBar"
import ExpBar from "../ui/ExpBar"
import { pause } from "../ui/pauseManager";
...
export default class PlayingScene extends Phaser.Scene {
  ...
  create() {
    ...
    /**
     * Phaser에서 physics object끼리 겹치는 것을 overlap이라고 합니다.
     * 특정 오브젝트끼리 겹쳤을 때 작용을 추가하고 싶다면 해당 오브젝트들이 있는 scene에 다음과 같은 코드를 추가하면 됩니다.
     * 자바스크립트의 `addEventListener`와 비슷한 작용을 하는 함수라고 생각하시면 됩니다.
  ...
  update() {
    // 이동은 부드럽게 일어나야 하므로 Scene의 매 프레임마다 실행되는 update 함수를 활용합니다.
    // movePlayerManager라는 메소드를 추가해줍니다.
