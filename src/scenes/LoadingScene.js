...
// load해 놓은 에셋은 전역적으로 사용 가능합니다.
export default class LoadingScene extends Phaser.Scene {
  // constructor를 만들어줍니다. super 안에 담긴 값은 이 scene의 identifier가 됩니다. 이 값을 이용해 특정 scene을 실행시키거나, 정지시키거나, 멈출 수 있습니다.
  constructor() {
  ...
  create() {
    ...
    // sprite image의 애니메이션을 생성해줍니다.
    //  - key: 애니메이션의 key가 됩니다.
    //  - frames: `this.anims.generateFrameNumbers("load한 spritesheet의 key")`로 입력하시면 됩니다.
    //    - start, end를 설정해 같은 spritesheet로 여러 애니메이션을 만들 수 있습니다.
    //  - frameRate: 초당 프레임 수를 설정합니다. (디폴트: 24)
    //  - repeat: 애니메이션 반복 횟수입니다. -1는 무한 반복입니다.
    //  - hideOnComplete: true로 설정하면 애니메이션이 끝난 후 이미지가 화면에서 사라집니다. (디폴트: false)
